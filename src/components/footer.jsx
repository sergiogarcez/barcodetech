...
const Footer = () => {
  ...
  return (
    <footer className="bg-white text-black py-10 border-t-2 border-dotted border-gray-300">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 ">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-20">
          ...
          <div className="text-center md:text-left">
            <h3 className="text-lg font-semibold text-black mb-3">Redes Sociais</h3>
            <div className="flex justify-center md:justify-start space-x-4 mb-6">
              <a href="https://facebook.com/suaempresa" target="_blank" rel="noopener noreferrer" className="hover:text-gray-600 transition-colors duration-200 text-2xl">
                <FaFacebook />
              </a>
              <a href="https://instagram.com/suaempresa" target="_blank" rel="noopener noreferrer" className="hover:text-gray-600 transition-colors duration-200 text-2xl">
                <FaInstagram />
              </a>
              <a href="https://linkedin.com/company/suaempresa" target="_blank" rel="noopener noreferrer" className="hover:text-gray-600 transition-colors duration-200 text-2xl">
                <FaLinkedin />
              </a>
              {/* Adicione um link direto para WhatsApp*/}
              <a href="https://wa.me/550012345678?text=Olá!%20Gostaria%20de%20saber%20mais%20sobre%20seus%20serviços." target="_blank" rel="noopener noreferrer" className="hover:text-gray-600 transition-colors duration-200 text-2xl">
                <FaWhatsapp />
              </a>
            </div>
          </div>
